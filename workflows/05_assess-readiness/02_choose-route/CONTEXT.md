...
This decision does not itself merge, deploy, or change the candidate.
...
1. Apply the scoped [definition of done](../../../_shared/definition-of-done.md#finished-project-workflow). Verify candidate identity, applicable proof, all material finding dispositions, and outstanding holds or recovery obligations. Required checks or unresolved material choices remain blocking unless their owning authority changes the requirement.
...
3. Before selecting merge, verify current head, base, live repository policy, required checks, review preconditions, and authority. The [GitHub delivery rules](../../../_shared/engineering/github-delivery-rules.md) own execution and verification of that selected action.
...
- A supported readiness decision, applicable finding dispositions, and one next route with its remaining obligations.
